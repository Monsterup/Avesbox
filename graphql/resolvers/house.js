...
module.exports = {
    ...
    createHouse: async (args, req) => {
        ...
        let house = new House({
            ...
            feedWarehouse: args.houseInput.feedWarehouse,
            company: company._id,
            creator: req.userId
        });
        let createdHouse;
        try {
            ...
            const feedWarehouse = await FeedWarehouse.findById(args.houseInput.feedWarehouse);
            if(!creator)
            ...
            feedWarehouse.houses.push(house);
